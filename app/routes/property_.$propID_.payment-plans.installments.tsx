...
export default function PaymentPlanInstallements() {
            ...
            <div className="w-full h-screen bg-purple-50 flex justify-center items-center ">
                <div className="w-full flex flex-col gap-2">
                    <Form method="post" className="flex flex-col gap-2">
                        ...
                        <button type='submit' className="rounded-md py-1 px-2 bg-red-500 text-gray-800 border"> Pay: {params.propID} </button> 
                        <Link to="" className="rounded-md py-1 px-2 bg-gray-200 text-gray-800 flex justify-center">Pay in installments</Link>
                    </Form>
